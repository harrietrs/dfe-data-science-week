...
#+REVEAL_HTML: <br>
#+REVEAL_HTML: <h3 style="color:white; text-align:left; text-transform:uppercase">Community of practice</h3>
...
*   
    :PROPERTIES:
    :reveal_background: #08ff92
    :END:
#+REVEAL_HTML: <h4 style="color:white; text-align:left; text-transform:capitalize">Get involved</h4>
#+REVEAL_HTML: <h4 style="text-align:left; text-transform:capitalize">Coffee and Coding</h4>
#+REVEAL_HTML: <h4 style="text-align:left; text-transform:capitalize">govdatascience slack</h4>
#+REVEAL_HTML: <h4 style="text-align:left; text-transform:capitalize">Community meet up</h4>
#+REVEAL_HTML: <h4 style="text-align:left; text-transform:capitalize">Data Science Accelerator – next cohort early 2020</h4>
#+REVEAL_HTML: <h4 style="text-align:left; text-transform:capitalize">RAP Champions</h4>
#+REVEAL_HTML: <h4 style="text-align:left; text-transform:capitalize">Gov Data Science Conference</h4>
